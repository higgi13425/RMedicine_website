...
In this data challenge, you will analyze MMR vacccination rates over time and by geographical area, as well as measles case rates and complications.
...
In addition to the provided datasets on this Github site, you may request to use additional publicly available data in your submission by submitting a request (with the dataset) by May 1st, 2024 at 5:00PM EST. If approved, the dataset will be made available to all participants.
...
Finalists will be **required** to present their project at the R/Medicine conference (can be prerecorded) on Friday afternoon in our closing session for the prizewinners on June 13, 2024.
